if (global.dual_controls != 1)
{
    ...
    draw_roundrect_color(400, 420, 480, 460, mk_c_color, mk_c_color, 0);
    ...
    if (global.mobile_f2 == 1)
        draw_roundrect_color(80, 0, 0, 30, mk_f2_color, mk_f2_color, 0);
    if (global.mobile_heal == 1)
        draw_roundrect_color(640, 30, 560, 0, mk_h_color, mk_h_color, 0);
    draw_set_alpha(1);
...
{
    draw_set_alpha(mk_button_alpha);
    draw_roundrect_color(400, 30, 480, 0, mk_c_color, mk_c_color, 0);
    draw_roundrect_color(480, 30, 560, 0, mk_x_color, mk_x_color, 0);
    draw_roundrect_color(560, 30, 640, 0, mk_z_color, mk_z_color, 0);
    if (global.mobile_f2 == 1)
        draw_roundrect_color(80, 0, 0, 30, mk_f2_color, mk_f2_color, 0);
    if (global.mobile_heal == 1)
        draw_roundrect_color(400, 30, 320, 0, mk_h_color, mk_h_color, 0);
    draw_set_alpha(1);
    draw_sprite_ext(spr_mobilekey, 0, 76, 296, 2, 2, 0, c_white, 0.41);
