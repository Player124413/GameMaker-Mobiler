if (global.dual_controls != 1)
{
    ...
    for (var i = 0; i < 4; i++)
    {
        ...
        if (device_mouse_check_button(i, mb_left))
        {
            ...
            else if (device_mouse_x_to_gui(i) >= 480 && device_mouse_y_to_gui(i) >= 51)
            {
                cx = 0.5;
                _ak = mk_x_button;
            }
            else if (device_mouse_x_to_gui(i) >= 400 && device_mouse_y_to_gui(i) >= 51)
            {
                cg = 0.5;
                _ak = mk_c_button;
            }
    ...
    if (mf2 == 0.5 && !keyboard_check(mk_f2_button))
        keyboard_key_press(mk_f2_button);

    if (mh == 0.5 && !keyboard_check(mk_h_button))
        keyboard_key_press(mk_h_button);
    ...
    if (mf2 == 1 && keyboard_check(mk_f2_button))
        keyboard_key_release(mk_f2_button);

    if (mh == 1 && keyboard_check(mk_h_button))
        keyboard_key_release(mk_h_button);
