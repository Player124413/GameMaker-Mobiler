...
{
    draw_sprite_ext(spr_button_up, keyboard_check(ord("W")), up2x, up2y, analog_scale, analog_scale, 0, button_colour, controls_opacity * image_alpha);
    draw_sprite_ext(spr_button_left, keyboard_check(ord("A")), left2x, left2y, analog_scale, analog_scale, 0, button_colour, controls_opacity * image_alpha);
    draw_sprite_ext(spr_button_right, keyboard_check(ord("D")), right2x, right2y, analog_scale, analog_scale, 0, button_colour, controls_opacity * image_alpha);
    draw_sprite_ext(spr_button_down, keyboard_check(ord("S")), down2x, down2y, analog_scale, analog_scale, 0, button_colour, controls_opacity * image_alpha);
}
